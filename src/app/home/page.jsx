...
<stop offset="1" stop-color="#1BC149"/>
    ...
    <div className="h-688 w-screen">
      <div className="flex justify-center items-center">
        <h1 className="font-semibold">Faça seu dinheiro trabalhar para você.</h1>
        <p>Por que usar o Organiza?</p>
      </div>
      ...
      <div className="flex items-center justify-center text-center h-688 bg-gradient-to-b from-custom1-green to-custom2-green">
        ...
        <h3 className="font-semibold text-64 w-1040">desenvolva, evolua e alcance seus objetivos conosco. Sua parceira financeira para um futuro seguro e próspero.</h3>
